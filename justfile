...
deploy-steamdeck:
    ...
    scp ./target/x86_64-unknown-linux-gnu/release/mixamo-to-glb deck@steamdeck.local:~/Downloads

# Quick deploy to Steam Deck (renames to 'game' for easy launching)
deploy-steamdeck-quick:
    just build-steamdeck
    scp ./target/x86_64-unknown-linux-gnu/release/mixamo-to-glb deck@steamdeck.local:~/Downloads/game
